...
function NavBar() {
	...
	//       <ul className="navbar-nav mx-3">
	//         <li className="nav-item">
	//         <a className={`btn btn-primary btn-sm me-3 ${role? "invisible": ""}`} href="/">Login</a>
	//         </li>
	//         <li className="nav-item">
	//         <button type="button" className={`btn btn-danger btn-sm ${role? "": "invisible"}`} onClick={logout}>logout</button>
	//         </li>
	//       </ul>
	//     </nav>
	//   </>
